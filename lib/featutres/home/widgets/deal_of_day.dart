...
import 'package:amazon/featutres/home/services/home_services.dart';
     ...
     child: Column(
        children: [
          ...
          Container(
            ...
            alignment: Alignment.topLeft,
            child: const Text('\$20', style: TextStyle(fontSize: 18),),
          ),
          Container(
            alignment: Alignment.topLeft,
            padding: const EdgeInsets.only(right: 40,top: 5, left: 15),
            child: const Text(
              'Radio ',
              maxLines: 2,
